...
class FrequencyResponse(Object):
    ...
    def evaluate(self, freqs):
        return num.ones(freqs.size, dtype=num.complex)
...
class Gain(FrequencyResponse):
    ...
    def evaluate(self, freqs):
        return util.num_full_like(freqs, self.constant, dtype=num.complex)
...
class IntegrationResponse(FrequencyResponse):
    ...
    def evaluate(self, freqs):
        nonzero = freqs != 0.0
        resp = num.zeros(freqs.size, dtype=num.complex)
