...
from pyrocko.dataset.pilab_faults import ActiveFaults
...
class RomActiveFaultsState(ElementState):
    visible = Bool.T(default=True)
    size = Float.T(default=3.0)
    color_by_slip_type = Bool.T(default=False)

    def create(self):
        element = RomActiveFaultsElement()
...
class RomActiveFaultsElement(Element):
...
__all__ = [
    'RomActiveFaultsElement',
    'RomActiveFaultsState'
]
